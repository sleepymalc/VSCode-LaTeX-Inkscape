...
There are actually an unoffical API for Grammarly, but the functionality is not that useful if one want to use auto-correction. Hence, I'll leave is as a TODO for now.
